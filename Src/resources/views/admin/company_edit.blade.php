                                        ...
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-sm-10">
                                                <input maxlength="255" type="text"
                                                    ...
                                                    id="com_tel" placeholder="{{ __('label.company.company_tell') }}">
                                                @error('com_tel')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-sm-10">
                                                <input maxlength="255" type="text"
                                                    ...
                                                    id="com_address" placeholder="{{ __('label.company.company_address') }}">
                                                @error('com_address')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-sm-10">
                                                <input maxlength="255" type="text"
                                                    ...
                                                    id="att_name" placeholder="{{ __('label.company.att_name') }}">
                                                @error('att_name')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-sm-10">
                                                <input maxlength="255" type="text"
                                                    ...
                                                    name="att_department" id="att_department" placeholder="{{ __('label.company.att_department') }}">
                                        ...
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-sm-10">
                                                <input maxlength="255" type="text"
                                                    ...
                                                    id="att_mail" placeholder="{{ __('label.company.att_email') }}">
                                                @error('att_mail')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
