...
<section class="content-dashboard">
    ...
    <h4 class="mb-2" style="border-bottom: 1px solid #000;font-weight: bold;margin-top: 25px;"><i class="nav-icon fas fa-file-alt" aria-hidden="true" style="margin-right: 5px;margin-bottom: 5px;"></i>{{ __('label.list_application') }}</h4>
    <div class="card">
    ...
    <div class="pagination-container">
        <div>{{ $list_application->appends(request()->input())->links() }}</div>
    </div>
    @endif
