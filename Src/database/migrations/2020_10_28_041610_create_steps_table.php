...
class CreateStepsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('steps', function (Blueprint $table) {
            ...
            $table->integer('order')->default(1)->comment('using to update status on applications table when user approved');
            $table->integer('select_order')->default(1)->comment('using get list approved of user by status');
